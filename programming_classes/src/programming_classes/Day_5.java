...
// another method
public static void automorphic2(int n) {
	int square  = n * n;
	int n1 = n;
	while(n!= 0) {
		int digit = n % 10;
	...
	if(n==0)
		System.out.println(n1+ " is an automorphic number --- method 2 ---");
	else
		System.out.println(n1+ " is not an automorphic number --- method 2 ---");
